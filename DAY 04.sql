...
SELECT LOWER("INFORMATION TECHNOLOGY"); -- information technology

--UPPER(String)/UCASE(String)
SELECT UPPER('Information Technology'); -- INFORMATION TECHNOLOGY

--LENGTH(String)
SELECT LENGTH('Information Technology'); -- 22
...
SELECT RIGHT('INFORMATION TECHNOLOGY', 8); -- CHNOLOGY
